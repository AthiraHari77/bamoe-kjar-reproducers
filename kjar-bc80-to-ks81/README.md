...
(JDK 11 / KIE 7.67.2.Final-redhat-00034) and deploying it directly to **KIE Server 8.1**,
then executing all four model types via curl and a Java client.

No Business Central 8.1 is involved — the KJAR goes straight to KIE Server.
